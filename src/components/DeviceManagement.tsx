...
export const DeviceManagement = ({
  ...
  if (isLoading)
    return (
      <p className="text-center py-8 animate-pulse text-gray-500">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-2xl font-bold flex items-center gap-2">
                <Wifi size={22} /> Device Management
                <Badge variant="outline">{devices.length}</Badge>
              </CardTitle>
              <CardDescription>
                Monitor and manage connected devices on Shield Network Guardian
              </CardDescription>
            </div>
